...
Projeto desenvolvido a partir das aulas do curso.dev.

Será realizado o clone do TabNews, que é um fórum permitindo posts e interação entre os usuários.

Segue meu diário de desenvolvimento e anotações.
